...
import javax.swing.*;
public class ventanaP04T07 implements MouseListener {
	JFrame marco;
            ...
            for (int y = 0; y < 7; y++) {
				if (boton[x][y] == botonPulsado) {
					if (e.getButton()==MouseEvent.BUTTON1){
						mainP04T07.botonIzquierdo(x, y);
						}
					else if(e.getButton()==MouseEvent.BUTTON3) {
						mainP04T07.botonDerecho(x, y);
					}
                    break;
                }
            }
	...
	public void ponerMinas(int fila, int columna) {
